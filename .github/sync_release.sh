...
UPSTREAM_REPO="https://github.com/MiSTer-devel/GameAndWatch_MiSTer.git"
CORE_NAME=(GameAndWatch)
...
UPSTREAM_CORE_NAME=(GameAndWatch)
MAIN_BRANCH="master"
UPSTREAM_BRANCH="master"
COMPILATION_INPUT=(GameAndWatch.qpf)
COMPILATION_OUTPUT=(output_files/GameAndWatch.rbf)
